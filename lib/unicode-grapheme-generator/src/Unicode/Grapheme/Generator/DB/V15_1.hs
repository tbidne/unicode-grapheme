...
import Unicode.Grapheme.Generator.Version (UnicodeVersion (UnicodeVersion_15_1))
...
generateModule mDataDir mDestDir = do
  ...
  eastAsianWidth <- DerivedEastAsianWidth.generateData mDataDir (104, 121935) vers
